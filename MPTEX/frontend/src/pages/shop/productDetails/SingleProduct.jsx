...
//   const [customization, setCustomization] = useState("");  // For customization text

//   const handleAddToCart = (product) => {
//     dispatch(addToCart({ ...product, customization }));  // Add customization to cart
//   };
...
//             <textarea
//               placeholder="Enter customization details (e.g., color, size, text)"
//               value={customization}
